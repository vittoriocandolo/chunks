...
/**
 * Inizialmente avevo deciso di usare LocalTime invece di LocalDateTime perchè mi sembrava favorire il riutilizzo dei percorsi
 * Probailmente per implementare alcuni metodi avrei dovuto usare LocalDateTime, ora non faccio in tempo
 * 
 * Inizialmente avevo scelto di usare eccezioni unchecked perchè il comportamento mi sembrava simili a quello di
 *  NullPointerException e IllegalArgumentException che appunto lo sono, mi rendo conto solo ora che così non ho lasciato
 *  nessun esempio di handling delle eccezioni però
 */
